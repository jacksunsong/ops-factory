...
public class SessionEndpointE2ETest extends BaseE2ETest {
    ...
    public void startSession_authenticated_callsStartThenResume() {
        ...
        webClient.post().uri("/ops-gateway/agents/test-agent/agent/start")
    ...
    public void listAllSessions_noInstances_returnsEmptyArray() {
        ...
        webClient.get().uri("/ops-gateway/sessions")
                .header(HEADER_SECRET_KEY, SECRET_KEY)
                .header(HEADER_USER_ID, "alice")
                .exchange()
                .expectStatus().isOk()
    ...
    public void listAgentSessions_authenticated_proxiesToGoosed() {
        ...
        webClient.get().uri("/ops-gateway/agents/test-agent/sessions")
                .header(HEADER_SECRET_KEY, SECRET_KEY)
                .header(HEADER_USER_ID, "alice")
                .exchange()
                .expectStatus().isOk();
    ...
    public void getSession_authenticated_proxiesToGoosed() {
        ...
        webClient.get().uri("/ops-gateway/agents/test-agent/sessions/session-123")
                .header(HEADER_SECRET_KEY, SECRET_KEY)
                .header(HEADER_USER_ID, "alice")
                .exchange()
                .expectStatus().isOk()
    ...
    public void deleteSession_authenticated_removesOwnerAndProxies() {
        ...
        webClient.delete().uri("/ops-gateway/agents/test-agent/sessions/session-456")
                .header(HEADER_SECRET_KEY, SECRET_KEY)
                .header(HEADER_USER_ID, "alice")
                .exchange()
                .expectStatus().isOk();
